...
/**
 * Servlet implementation class updateProductionServlet
 */
@WebServlet("/updateProductionServlet")
public class updateProductionServlet extends HttpServlet {
     ...
     */
    public updateProductionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int check = 0;
		try {
			check = pd.update(no, name, address, date, owner);
		} catch (Exception e) {
